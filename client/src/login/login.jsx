...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex text-left bg-white dark:bg-slate-900">
      {/* Left Side — Form */}
      <div className="relative w-full lg:w-1/2 px-5 py-8 sm:p-8 flex flex-col justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden>
          <motion.div
            ...
            className="absolute -top-32 -left-32 w-[420px] h-[420px] bg-blue-400/20 dark:bg-blue-500/10 rounded-full blur-3xl"
          />
          <motion.div
            animate={{ scale: [1, 1.2, 1], opacity: [0.08, 0.15, 0.08] }}
            transition={{ duration: 11, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
            className="absolute bottom-0 -right-24 w-[360px] h-[360px] bg-indigo-400/15 dark:bg-indigo-500/8 rounded-full blur-3xl"
          />
        </div>
        ...
        <div className="relative max-w-md mx-auto w-full">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, ease: EASE }}>
            <h1 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white mb-2">Log in to your account</h1>
            <p className="text-gray-500 dark:text-gray-400 mb-8 text-sm">Patients, doctors and admins all sign in here.</p>
          </motion.div>
          ...
          >
            ...
            <motion.button
              ...
              type="submit"
              disabled={submitting}
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-3 rounded-xl font-bold transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mb-4 shadow-lg shadow-blue-200/50 dark:shadow-none"
            >
              {submitting && (
      ...
      {/* Right Side — Branding */}
      <div className="hidden lg:flex relative w-1/2 bg-gradient-to-br from-blue-50 via-indigo-50 to-white dark:from-slate-900 dark:via-slate-800/60 dark:to-slate-900 p-8 flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden>
          <motion.div
            animate={{ scale: [1, 1.18, 1], opacity: [0.14, 0.22, 0.14] }}
            transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute -top-24 right-1/4 w-[420px] h-[420px] bg-blue-400/20 dark:bg-blue-500/10 rounded-full blur-3xl"
          />
          <motion.div
            animate={{ scale: [1, 1.15, 1], opacity: [0.1, 0.18, 0.1] }}
            transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut', delay: 3 }}
            className="absolute -bottom-16 left-1/4 w-[360px] h-[360px] bg-indigo-400/15 dark:bg-indigo-500/8 rounded-full blur-3xl"
          />
        </div>
        ...
        <motion.div
          ...
          className="relative w-32 h-32 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full mb-8 flex items-center justify-center shadow-xl shadow-blue-200/50 dark:shadow-none"
        >
