  ...
  return (
    <form onSubmit={handleSearch} className="bg-white rounded-lg shadow-lg p-4">
      <div className="flex">
        ...
        <div className="w-2/3 flex items-center border-r border-sand-200 pr-2">
          <div className="px-4">
            <FiSearch className="w-5 h-5 text-sand-400" />
          </div>
          <input
            type="text"
            value={query}
            ...
            className="w-full py-3 px-2 outline-none text-sand-700"
          />
        </div>
        ...
        <div className="w-1/3 flex items-center pl-2">
          <div className="px-2">
            <FiMapPin className="w-5 h-5 text-sand-400" />
          </div>
          <input
            type="text"
            value={location}
        ...
        <button
          type="submit"
          className="bg-yellow-400 hover:bg-yellow-500 text-sand-900 px-6 py-3 rounded-md font-medium transition-colors ml-2"
        >
          Search
        </button>
      </div>
